...
- **Pendientes**: bootstrapping doble (compiler_v4 compila vm.nv → vm.nvc corre en VM LÚMEN → 0 dependencias de Rust) → release v2.4.0 (tag) → FFI natives VM LÚMEN (cluster `__ffi_*`) → AI/ML (Fases 186-200).
