...
> **v3.94.23+**: si el bloque contiene efectos secundarios o variables de
> runtime (no evaluable en compilación), el compilador emite el error **E090**.
> `comptime` siempre evalúa en tiempo de compilación; nunca degrada a runtime.
