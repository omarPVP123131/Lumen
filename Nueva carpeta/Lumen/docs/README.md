...
│   ├── GUIA_LENGUAJE.md           — guía práctica verificada (structs, enums, mapas,
│   │                                closures, rangos, casts, unicode…) VM⇄AOT v3.94.24
│   ├── ESPECIFICACION_FORMAL_LUMEN.md — especificación formal completa
│   ├── HERRAMIENTAS.md            — catálogo de herramientas (REPL, LSP, debugger)
│   ├── concurrencia.md            — referencia de stdlib/concurrencia.nv (hilos, mutex, canales)
...
└── informes/              — informes y reportes históricos
    ...
    ├── AUDITORIA_V39423_RESOLUCION.md — resolución de la auditoría v3.94.22 (bugs A–K)
    ├── AUDITORIA_V39424.md          — auditoría v3.94.23 → v3.94.24 (casts, bucles, bits, slices, rangos, ternarios, closures, mapas + benchmark)
