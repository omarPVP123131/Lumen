...
**v3.5.7 Producción Real — Released: 21 Agosto 2026 — 956 tests, CHUNK_VERSION 7, bench 8, headless `es_headless()` — + rondas JIT v3.5.31→v3.5.39 (30 Ago 2026: registros en bucles + inlining, TOTAL ~245 ms; ver [CHANGELOG](../../CHANGELOG.md) y [arquitectura/jit.md](../arquitectura/jit.md))**
