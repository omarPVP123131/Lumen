...
**Plan Oficial de Formación Acelerada — LÚMEN v3.5.7 Producción Real (21 Ago 2026) — 956 tests, bench 8, headless `es_headless()`, `CHUNK_VERSION 7`**

> **Producción Real:** checklist en [docs/produccion.md](produccion.md) — `cargo test --workspace` (956), `cargo bench -p lumen-bench` (8), `LUMEN_HEADLESS=1 CI=1` para CI/headless, `VERSION` 3.1.4.
...
```bash
# Checklist producción v3.5.7 (docs/produccion.md):
...
*LÚMEN Curriculum — De 0 a Ingeniero de Software Certificado — v3.5.7 Producción Real (956 tests, bench 8, `LUMEN_HEADLESS`, `CHUNK_VERSION 7`).*
