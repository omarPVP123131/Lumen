...
**Plan Oficial de Formación Acelerada — LÚMEN v3.3.0 Producción Real (21 Ago 2026) — 917 tests, bench 8, headless `es_headless()`, `CHUNK_VERSION 7`**
...
```bash
# Checklist producción v3.1.4 (docs/produccion.md):
...
*LÚMEN Curriculum — De 0 a Ingeniero de Software Certificado — v3.3.0 Producción Real (917 tests, bench 8, `LUMEN_HEADLESS`, `CHUNK_VERSION 7`).*
